...
DumpStyle(bond/tbbm,DumpBondTBBM)

#else

#ifndef LMP_DUMP_BOND_TBBMD_H
#define LMP_DUMP_BOND_TBBMD_H

#include "dump.h"

namespace LAMMPS_NS {

class DumpBondTBBM : public Dump {
 public:
  DumpBondTBBM(LAMMPS *, int, char **);
  ~DumpBondTBBM();
 ...
 private:
  ...
  typedef void (DumpBondTBBM::*FnPtrWrite)(int, double *);
  ...
  typedef void (DumpBondTBBM::*FnPtrPack)(int);
  ...
  void pack_barea(int);
  void pack_tensile_stress(int);
  void pack_compression_stress(int);  
  void pack_shear_stress(int);  
  void pack_btorqueT(int);  
  void pack_btorqueN(int);  
  void pack_bforceN(int);  
  void pack_bforceT(int);
  void pack_bondtype(int);
  void pack_compression_ratio(int);
  void pack_tensile_ratio(int);
  void pack_shear_ratio(int);
  void pack_bforceX(int);
  void pack_bforceY(int);
  void pack_bforceZ(int);
  void pack_btorqueX1(int);
  void pack_btorqueY1(int);
  void pack_btorqueZ1(int);
  void pack_btorqueX2(int);
  void pack_btorqueY2(int);
  void pack_btorqueZ2(int);
};
