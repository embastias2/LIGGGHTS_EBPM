...
FixStyle(eraseforces,FixEraseForces)

#else

#ifndef LMP_FIX_ERASEFORCES_H
#define LMP_FIX_ERASEFORCESS_H

#include "fix.h"

namespace LAMMPS_NS {

class FixEraseForces : public Fix {
 public:
  FixEraseForces(class LAMMPS *, int, char **);
  ~FixEraseForces();
  int setmask();
  void init();
  void setup(int);
